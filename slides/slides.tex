...
\only<3>{\includegraphics[height=3.3cm]{protein-graph}\\\hfill\paper{Borgwardt et al., 2005; Vishwanathan et al., 2010}}%
\only<4>{\includegraphics[height=3.43cm]{keil.png} \qquad \includegraphics[height=3.4cm]{graph.pdf}\\\paper{Kriege et al., 2018}}%
\end{center}


% \begin{block}{Application areas with structured data}%\vspace{-.1em}
% \begin{columns}[c]
%   \column{0.45\textwidth}
% 	 \begin{itemize}
% 	   \item \alert<6>{Social network analysis}
% 	   \item \alert<7>{Bioinformatics}
% 	   \item \alert<8>{Computer vision}
% 	   \item \alert<9-10>{Cheminformatics}
% 	   \end{itemize}
%     \vspace{.67em}
%   \column{0.45\textwidth}\centering%
%    \only<6>{\includegraphics[height=2.7cm]{Social_Network_Analysis_Visualization.png}}%
%    \only<7>{\includegraphics[height=2.7cm]{protein-graph}}%
%    \only<8>{\includegraphics[height=2.7cm]{keil.png}}%
%    \only<9>{\includegraphics[height=2.7cm]{caffeine}}%
%    \only<10->{\includegraphics[height=2.7cm]{molecule_cloud.png}}%
% \end{columns}
% \end{block}
