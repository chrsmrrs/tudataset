...
def main():
    ...
    print(val.linear_svm_evaluation(all_matrices, classes, num_repetitions=1, all_std=True, primal=True))
    ...
    #     all_matrices.append(gm)
    # print(val.kernel_svm_evaluation(all_matrices, classes,num_repetitions=10, all_std=True))


    #print(gnn_evaluation(GIN0, dataset, [26], [64], num_repetitions=10, all_std=True))
