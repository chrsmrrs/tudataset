...
\begin{table*}[ht]\centering		
	...
	\label{t2l}	
	\resizebox{0.8\textwidth}{!}{ 	\renewcommand{\arraystretch}{.95}
...
\begin{table*}[t]\centering		
	...
	\label{t2ll}	
	\resizebox{0.75\textwidth}{!}{ 	\renewcommand{\arraystretch}{.95}
	...
	\begin{center}
		...
		\resizebox{1.0\textwidth}{!}{ 	\renewcommand{\arraystretch}{1.05}
			\begin{tabular}{@{}lcccccc@{}}\toprule
				...
				\midrule        
				%$\textsc{Zinc (10k)}$       & 12\,000 & 12	&&	     & \cmark  & \cmark           \\
				%$\textsc{Zinc (50k)} $       & 60\,000  & 12	&&	     & \cmark  & \cmark           \\
				$\textsc{Zinc}$       &  249\,456 &12	&23.1 &	24.9     & \cmark  & \cmark           \\
				
				%$\textsc{Alchemy (10k)}$       & 12\,000 &12	& &	     & \cmark  & \cmark           \\
				%$\textsc{Alchemy (50k)} $       &60\,000 &12	&&	     & \cmark  & \cmark           \\
