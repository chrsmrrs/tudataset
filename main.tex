		...
		\begin{tabular}{@{}c <{\enspace}@{}lccccc@{}}	\toprule
			...
			& & {\textsc{Mcf-7}}         &  {\textsc{Molt-4}}      & {\textsc{Triangles}}           & {\textsc{github\_stargazers}}       & {\textsc{reddit\_threads}}      \\	\toprule
							\multirow{3}{*}{\rotatebox{90}{Kernel}}	& \text{1-WL}    & 
							   $94.5$ \scriptsize $\pm  0.0 \pm 0.4$       &$94.6$ \scriptsize $\pm 0.1  \pm 0.3$ & $36.5$ \scriptsize $\pm 0.1\pm0.7$ &  $63.9$ \scriptsize $\pm 0.1\pm1.3$ &$77.0$ \scriptsize $\pm 0.0\pm0.3$  \\
		
			& \text{GR}            & $91.7$  \scriptsize $\pm  0.0  \pm 0.5 $       & $92.1$ \scriptsize $\pm 0.0 \pm 0.4$ & $14.3$ \scriptsize $\pm 0.0 \pm 0.6$ &  $53.5$ \scriptsize $\pm 0.0 \pm1.3$ & $51.2$ \scriptsize $\pm 0.0 \pm 0.4$  \\  
			& \text{SP}             &  $91.7$  \scriptsize $\pm 0.0 \pm 0.4 $       &$92.1$  \scriptsize $\pm 0.0 \pm 0.4 $ & $16.5$ \scriptsize $\pm 0.1 \pm 0.4$ & $64.1$ \scriptsize $\pm 0.1\pm1.4$ & $77.3$ \scriptsize $\pm 0.0 \pm0.3$  \\   
			\cmidrule{2-7}	
